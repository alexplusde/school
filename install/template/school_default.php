...
<html class="template-REX_TEMPLATE_KEY" lang="<?= $clang->getCode(); ?>">
    ...
    <body>
        ...
        <script src="<?= speed_up_asset::getUrl("addons/school/js/jquery.flexslider-min.js") ?>"></script>
        <script src="<?= speed_up_asset::getUrl("addons/school/js/jquery.tablesorter.combined.min.js") ?>"></script>
